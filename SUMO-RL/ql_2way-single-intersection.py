...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="/home/jay/RL-examples/SUMO-RL/inputs/single-intersection-vhvh.rou.xml",
    ...
    out_csv = f"SUMO-RL/outputs/2way-single-intersection/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}_reward{args.reward}"
